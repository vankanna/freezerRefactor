    ...
    template: `
        <v-flex class="item">
            ...
            <inventory-alert :quantity="parseInt(this.item.quantity, 10)"></inventory-alert>
                ...
                <div class="d-flex justify-space-between text-h6 text--primary">{{this.item.expiration}} <span class="d-flex justify-space-between text-h6">
                ...
                </v-card-actions>{{this.item.quantity}}</span></div>
                </v-card-text>
                <v-divider></v-divider>
                <v-card-actions>
                ...
                <edit-item :item="this.item" :overlay="overlay"></edit-item>
            </v-card>
        </v-flex>
    `,
